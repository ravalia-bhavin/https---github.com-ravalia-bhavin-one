...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.length === 0 || email.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          "service_64hwi0i", // service id
          "template_js7khhg", // template id
          mailData,
          "CGqFiZacb_v8MOto-" // public api
      ...
      <div className="contact-container">
        ...
        <div className="container page-title text-center">
          ...
          <span className="title-head-subtitle">
           ...
           Interested in talking about computer & technology. Feel free to contact!
          </span>
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+91 7575852639</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">ravaliabhavin01@gmail.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">linkedin.com/in/bhavinravalia/</span>
                  </h6>
                </li>
